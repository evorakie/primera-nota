const trabajitos = [
    {
        id: 1,
        photo: "https://github.com/evorakie/primera-nota/blob/main/img/topcycle.webp?raw=true",
        title: "TopCycle - Diseño Recidual",
        description: "Proyecto III, con Prof. Clarisa Menteguiaga"
    },
    {
        id: 2,
        photo: "https://raw.githubusercontent.com/evorakie/primera-nota/refs/heads/main/img/conejo.webp",
        title: "Conejo - Animal formado con Planos Plegados",
        description: "Procesos y Prototipos II, con Prof. Patricio Araya"
    },
    {
        id: 3,
        photo: "https://github.com/evorakie/primera-nota/blob/main/img/taconinfo.webp?raw=true",
        title: "Tacones - Infografía sobre Indumentaria",
        description: "Proyecto III, con Prof. Clarisa Menteguiaga"
    },
    {
        id: 4,
        photo: "https://github.com/evorakie/primera-nota/blob/main/img/taconobjwebp.webp?raw=true",
        title: "Tacones - Objeto infográfico  sobre Indumentaria",
        description: "Proyecto III, con Prof. Clarisa Menteguiaga"
    },
    {
        id: 5,
        photo: "https://github.com/evorakie/primera-nota/blob/main/img/lesbinfo.webp?raw=true",
        title:"The Lesbian Avengers - Infografía sobre Movimientos Sociales",
        description: "Proyecto III, con Prof. Clarisa Menteguiaga"
    },
    {
        id: 6,
        photo: "https://raw.githubusercontent.com/evorakie/primera-nota/refs/heads/main/img/lesbifanzine.webp",
        title: "The Lesbian Avengers - Fanzine sobre Movimientos Sociales",
        description: "Proyecto III, con Prof. Clarisa Menteguiaga"
    },
    {
        id: 7,
        photo: "https://raw.githubusercontent.com/evorakie/04-herramientas-computacionales/refs/heads/main/img/11.webp",
        title: "Sensacional - Diseño de Imagen Corporativa",
        description: "Procesos y Prototipos I, con Prof. Pamela Fuentes"
    },
    {
        id: 8,
        photo: "https://github.com/evorakie/primera-nota/blob/main/img/sensacionalinfo.webp?raw=true",
        title: "Kit Primera Lectura - Infografía de Pakacying",
        description: "Procesos y Prototipos I, con Prof. Pamela Fuentes"
    },       
]
...
function draw() {
    ...
    */
    ...
    cylinder(valor / 3.2, valor / 20);
    pop();
  
    //la cinta del sombrero blanca
    push();
    fill(0, 0, 255);
    translate(0, -valor/5, 0);
    cylinder(valor / 6, valor / 20);
    pop();
  
   //la cinta del sombrero roja
    push();
    fill(255, 0, 0);
    translate(0, -valor/3.72, 0);
    cylinder(valor / 6, valor / 35);
    pop();

   //la cinta del sombrero azul
    push();
    fill(255);
    translate(0, -valor/4.2, 0);
    cylinder(valor / 6, valor / 35);
    pop();
    ...
    //una mejilla
    push();
    fill("rgb(238, 165, 146)");
    translate(-valor / 9, valor / 15, valor / 6);
    sphere(valor / 15);
    pop();
